...
% The inner products of the columns of B and the constraint matrix should
% be zero. This function finds the matrix of errors and returns the norm.

function[err_norm] = constraint_check(constraints, B)
